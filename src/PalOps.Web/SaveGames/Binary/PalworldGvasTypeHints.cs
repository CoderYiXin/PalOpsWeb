...
/// <summary>
/// Palworld stores map and set element types as the generic Unreal
/// <c>StructProperty</c> name. The concrete struct type is therefore inferred from
/// the logical property path, matching the path hints used by PalworldSaveTools.
/// </summary>
internal static class PalworldGvasTypeHints
{
