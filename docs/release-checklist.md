...
本清单用于 PalOps Web **1.2.0** 的 GitHub 源码与 Windows `win-x64` 发布。
...
- [ ] `artifacts/palops-web-1.2.0-win-x64/`、ZIP 与 `.sha256` 同时生成；
- [ ] 解压后可由 `start.cmd` 启动；
- [ ] `wwwroot` 为当前构建；
...
- [ ] 创建 `v1.2.0` 标签；
- [ ] 上传 ZIP 和 SHA-256；
- [ ] 发布说明引用 `CHANGELOG.md` 的 1.2.0 条目；
