...
Each locale index contains **1,242** records with the same stable IDs and coordinates.

| Group | Category | Count |
|---|---|---:|
| Locations | Fast Travel | 85 |
...
| **Total** | **30 static categories** | **1,242** |
