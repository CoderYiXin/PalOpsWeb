...
This directory contains only the operator, developer, architecture, data, and release documentation required for the current 1.3.1 open-source publication. Historical design drafts, one-off defect reports, internal plans, and packaging audits are excluded.

## Product and operations

| Document | Scope | 中文 |
|---|---|---|
| [Complete feature reference](features.en.md) | Every 1.3.1 module, role, data source, and security boundary | [功能参考](features.md) |
